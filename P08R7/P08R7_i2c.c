...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PB14     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = TOF_I2C2_SCL_PIN |TOF_I2C2_SDA_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_I2C2;
    HAL_GPIO_Init(TOF_I2C2_SDA_PORT, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB14     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(TOF_I2C2_SCL_PORT, TOF_I2C2_SCL_PIN);

    HAL_GPIO_DeInit(TOF_I2C2_SDA_PORT, TOF_I2C2_SDA_PIN);
