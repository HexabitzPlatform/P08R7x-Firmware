/*
 ...
 File Name     : P08R7.c
 Description   : Source code for module P08R7.
 IR Time-if-Flight (ToF) Sensor (ST VL53L1CX)

 Required MCU resources :

 >> USARTs 1,2,3,4,5,6 for module ports (P08R7).
...
Module_Status statusD = P08R7_OK;
