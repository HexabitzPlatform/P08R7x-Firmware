/*
 ...
 File Name  : P08R7.h
 Description: Header file for P08R7 module, supporting IR Time-of-Flight (ToF) sensor (ST VL53L1CX).
...
/* Includes ****************************************************************/
#include "BOS.h"
#include "P08R7_MemoryMap.h"
#include "P08R7_uart.h"
#include "P08R7_gpio.h"
#include "P08R7_i2c.h"
#include "P08R7_dma.h"
#include "P08R7_inputs.h"
#include "P08R7_eeprom.h"
#include "Application_VL53L1.h"

/* Exported Macros *********************************************************/
#define	MODULE_PN		_P08R7
...
typedef enum {
	P08R7_OK = 0,
	P08R7_ERR_UNKNOWNMESSAGE,
	P08R7_ERR_WRONGPARAMS,
